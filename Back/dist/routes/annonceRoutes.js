...
const { createAnnonce, getAnnonces, getAnnonceDetails, updateAnnonce, deleteAnnonce } = require('../controllers/annonceController'); // Assurez-vous du bon chemin vers le contrôleur
